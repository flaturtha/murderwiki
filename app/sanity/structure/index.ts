...
import { Disc, Book, Home, Tags, Users } from "lucide-react";
...
export const structure: StructureResolver = (S) =>
  S.list()
    ...
    .items([
      ...
      S.divider(),
      // Document lists
      S.documentTypeListItem("novel").title("Novels").icon(Book),
      S.documentTypeListItem("record").title("Records").icon(Disc),
      S.documentTypeListItem("author").title("Author").icon(Users),
      S.divider(),
